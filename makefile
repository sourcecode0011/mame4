...
ifdef AARMV7
MYPREFIX=/home/chenguowen/gamendkso/sunchip/other/toolchainr10e-19/bin/arm-linux-androideabi-
#MYPREFIX=/home/david/Projects/android/my-android-toolchain-r9-18/bin/
BASE_DEV=/home/chenguowen/gamendkso/sunchip/other/toolchainr10e-19/sysroot
endif
...
$(OBJ)/build/file2str$(CCEXE):
	mkdir -p  $(OBJ)/prec-build/
	gcc $(OBJ)/../../../src/build/file2str.c -o file2str
	cp file2str $(OBJ)/prec-build/
	cp file2str $(OBJ)/build/

$(OBJ)/build/m68kmake$(CCEXE):
	cp  $(OBJ)/../../../src/emu/cpu/m68000/m68kmake $(OBJ)/prec-build/
	cp  $(OBJ)/../../../src/emu/cpu/m68000/m68kmake $(OBJ)/build/

$(OBJ)/build/png2bdc$(CCEXE):
#	gcc -I$(OBJ)/../../../src/lib/util/ -I$(OBJ)/../../../src/osd $(OBJ)/../../../src/build/png2bdc.c -o png2bdc 
	cp png2bdc $(OBJ)/prec-build/
	cp png2bdc $(OBJ)/build/

$(OBJ)/build/tmsmake$(CCEXE):
	cp  $(OBJ)/../../../src/emu/cpu/tms57002/tmsmake $(OBJ)/prec-build/
	cp  $(OBJ)/../../../src/emu/cpu/tms57002/tmsmake $(OBJ)/build/ 

$(OBJ)/build/verinfo$(CCEXE):
	gcc $(OBJ)/../../../src/build/verinfo.c -o verinfo 
	cp verinfo $(OBJ)/prec-build/
	cp verinfo $(OBJ)/build/
