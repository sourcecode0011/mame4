...
#if defined(ANDROID)
#if !DISABLE_OTHER
static void android_output_error(void *param, const char *format, va_list argptr)
{
	char buffer[1024];
...
extern "C"
int android_main  (int argc, char **argv,const char* game)
#elif defined(IOS)
extern "C"
...
#endif
{
	...
	printf("Iniciando\n");
#if !DISABLE_OTHER
    mame_set_output_channel(OUTPUT_CHANNEL_ERROR, android_output_error, NULL, NULL, NULL);
#endif
